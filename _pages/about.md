...
latest_posts:
  ...
  limit: 3 # leave blank to include all the blog posts, Financial Mathematics,  Bayesian Optimisation, Uncertainty Quantification, Gaussian Processes.
---
...
2022-Present [EPSRC Funding](https://www.ukri.org/councils/epsrc/) for PhD research, University of Edinburgh  

2021-2022 [FSMP Scholarship](https://sciencesmaths-paris.fr/en) for Master study, Paris  Dauphine University  

2021-2022 [AIMS Cameroon](https://aims-cameroon.org/) for structured Master study (Very good) 
...
Sampling, Computational Statistics, MCMC, Probability, Optimisation, PDMP, Probabilistic Machine Learning, Inverse problems. 
