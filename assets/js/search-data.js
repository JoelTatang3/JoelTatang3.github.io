...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Find the list of some of my publications here.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Find here a simplified version of my CV",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-a-simple-inline-announcement-a-second-announcement-and-a-third",
          title: 'A simple inline announcement. A second announcement and a third',
          description: "",
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-i-have-attended-the-workshop-advances-in-mcmc-methods-at-eurandom-tu-eindhoven-sparkles-where-i-have-presented-a-poster-on-my-work-on-constrained-sampling-see-poster-here",
          title: 'I have attended the workshop Advances in MCMC methods at Eurandom (TU Eindhoven...',
          description: "",
          section: "News",},{id: "news-i-have-attended-the-siam-conference-on-optimization-at-the-university-of-edinburgh-during-which-i-have-help-in-the-organization-as-a-volunteer-sparkles-see-certificate",
          title: 'I have attended the SIAM conference on Optimization at The University of Edinburgh...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%6F%65%6C%74%61%74%61%6E%67%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/JoelTatang3", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
